...
public class Contact {
    ...
    public Contact(String fer, String cadena, String password, String string, String fmcadenaespeeduec, String description, String femenine, ArrayList<Vehicle> arrayList, LocalDateTime MIN, int i) {
