...
public class ContactController {
    ...
    public ArrayList<Contact> find(String email){
        ...
        Contact contact = new Contact("alexander", "pachacama", "password "," 0961194040","efona1@.espe.edu.ec","description", "male", new ArrayList<Sport>,LocalDateTime, int monthIknewThisContact);
