 ...
 */
public class FrmCreateNews extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Create Your Forms");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCreateNews.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCreateNews().setVisible(true);
            }
        });
    }
