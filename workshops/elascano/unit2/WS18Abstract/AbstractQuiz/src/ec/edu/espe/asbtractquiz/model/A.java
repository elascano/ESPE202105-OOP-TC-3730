...
public class A {
    ...
    public A m(int m, int n){       //1
        System.out.println("usign the method m(int m, int n), using ints m -> " + m + " and n " + n);
        A a;
        A a1 = new A();
        A[] as = new A[2];
        B[] bs = new B[5];
    ...
    public String toString() {      //1
        return "A{" + "a=" + a + ", b=" + b + ", a1=" + a1 + ", "
                + "a2=" + a2 + ", as=" + as + ", bs=" + bs + ", "
                + "cs=" + cs + '}';
    }

    public A(int a, int b, A a1, A a2, A[] as, B[] bs, ArrayList<C> cs) {   //1
        this.a = a;
        this.b = b;
        this.a1 = a1;
        this.a2 = a2;
