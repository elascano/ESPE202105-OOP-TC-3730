...
public class FrmDatabaseSetup extends javax.swing.JFrame {
    ...
    private void btnLogInDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogInDatabaseActionPerformed
        ...
        if (database != null) {
            ...
            FrmSearchCountries frmSearchCountries;
            try {
                frmSearchCountries = new FrmSearchCountries();
                frmSearchCountries.setVisible(true);
            } catch (ParseException ex) {
                Logger.getLogger(FrmDatabaseSetup.class.getName()).log(Level.SEVERE, null, ex);
            }
            dispose();
        } else {
