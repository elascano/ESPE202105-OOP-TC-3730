...
public class DBManager implements PersistenceI {
    ...
    public boolean update(String searchString, String data, String table) {
        //TODO update dara in the database collection table according to the searchString
       return true;
    }
    ...
    public String find(String searchString, String table) {
         //TODO find a record in the tabñe database collection according to searchString
        return"{}";
    }
