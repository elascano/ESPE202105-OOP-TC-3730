...
public class ContactController {
    ...
    public void add(Contact contact){
        ...
        String contactJson = "{\"firstname\":\"Kevin\"}";
    ...
    public ArrayList<Contact> find(String email){
        ...
        Contact contact = new Contact("KA", "Barrera", "password", "0997690969", "kabarrera3@espe.edu.ec", "description", "male", new ArrayList<Sport>(), LocalDateTime.MIN, 0);
