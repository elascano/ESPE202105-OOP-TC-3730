...
public class ContactController {
    ...
    public ArrayList<Contact> find(String email){
        ...
        Contact contact = new Contact("Andrea","Quichimbo","password "," 0983739281","aequichimbo@.espe.edu.ec","description", "male", new ArrayList<Sport>,LocalDateTime, int monthIknewThisContact);
