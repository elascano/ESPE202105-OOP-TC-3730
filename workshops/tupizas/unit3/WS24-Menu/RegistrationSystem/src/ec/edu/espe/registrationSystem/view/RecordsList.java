 ...
 * OOP-ESPE
 */
public class RecordsList extends javax.swing.JFrame {

    /**
     * Creates new form DocumentsList
     */
    public RecordsList() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordsList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordsList().setVisible(true);
            }
        });
    }
