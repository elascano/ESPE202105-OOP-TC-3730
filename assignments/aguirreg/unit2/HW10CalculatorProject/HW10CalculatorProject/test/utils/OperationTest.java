...
public class OperationTest {
     ...
     */
    @Test
    public void testAddDecimalsPositiveNegative() {
        System.out.println("add");
        float addend1 = -3.0F;
        float addend2 = 7.0F;
     ...
     */
    @Test
    public void testSubtractDecimalsPositive() {
        System.out.println("subtract");
        float minuend = 7.0F;
        float subtrahend = 5.0F;
     ...
     */
    @Test
    public void testSubtractDecimalsPositiveNegative() {
        System.out.println("subtract");
        float minuend = 6.2F;
        float subtrahend = -2.2F;
