...
public class Chicken {
    ...
    public String [] getArray(){
        String [] agedata = {String.valueOf(id), name, color, String.valueOf(date), String.valueOf(born0n), String.valueOf(age), String.valueOf(molting), String.valueOf(eggCounter)};
        return agedata;
    }
