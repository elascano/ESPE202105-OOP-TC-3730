...
public class Main {
   /**
    ...
    public static void main(String[] args) {
       ...
       Cow cow1 = new Cow(true, 1, "Limousin", date); 
       System.out.println("Cow -> " + cow1);
       farmAnimals.add(cow1); 
       cows.add(cow1); 

       
       Cow cow2 = new Cow(true, 2, "Pardo Suizo", date); 
       System.out.println("Cow -> " + cow2);
       farmAnimals.add(cow2); 
       cows.add(cow2); 

       Cow cow3 = new Cow(true, 3, "holstein", date); 
       ...
       Sheep sheep1 = new Sheep(date, 1, "Awassi", date);        
       System.out.println("Sheep -> " + sheep1);
       farmAnimals.add(sheep1);
       sheeps.add(sheep1); 

           
       Sheep sheep2 = new Sheep(date, 2,"ladoum", date); 
       System.out.println("Sheep -> " + sheep2);
       farmAnimals.add(sheep2);
       sheeps.add(sheep2); 

        
       Sheep sheep3 = new Sheep(date, 3,"Racka", date); 
