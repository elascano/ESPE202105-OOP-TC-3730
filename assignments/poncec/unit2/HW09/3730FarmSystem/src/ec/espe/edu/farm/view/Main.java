...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        chicken = new Chicken(1, "Dorking", date, false);
        farmAnimals.add(chicken);
        System.out.println("chicken ->" + chicken);
        chicken = new Chicken(2, "Ancona", date, false);
        farmAnimals.add(chicken);
        System.out.println("chicken ->" + chicken);
        chicken = new Chicken(3, "Orpington", date, true);
        farmAnimals.add(chicken);
        System.out.println("chicken ->" + chicken);
        ...
        cow = new Cow(2, "Pardo suizo", date, true);
        farmAnimals.add(cow);
        System.out.println("cow -> " + cow);
        cow = new Cow(3, "Simmental", date, true);
        farmAnimals.add(cow);
        System.out.println("cow -> " + cow);
        ...
        sheep = new Sheep(1, "Karakul", date, date);
        farmAnimals.add(sheep);
        System.out.println("sheep -> " + sheep);
        sheep = new Sheep(2, "Texel", date, date);
        farmAnimals.add(sheep);
        System.out.println("sheep -> " + sheep);
        sheep = new Sheep(3, "Romanov", date, date);
        farmAnimals.add(sheep);
        System.out.println("sheep -> " + sheep);
