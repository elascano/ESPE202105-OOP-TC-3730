...
public class FrmDatabaseSetup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/espe/workshop/images/imgDatabase.png"))); // NOI18N
    ...
    private void btnLogInDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogInDatabaseActionPerformed
        ...
        if (database != null) {
            ...
            try {
                FrmShowTable frmShowTable = new FrmShowTable();
                frmShowTable.setVisible(true);
                dispose();
