 ...
 */
package ec.edu.chickensimulationjc.view;

import com.csvreader.CsvWriter;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import ec.edu.chickensimulationjc.model.Age;
import static ec.edu.chickensimulationjc.model.Age.calculateDays;
import static ec.edu.chickensimulationjc.model.Age.calculateMonth;
import static ec.edu.chickensimulationjc.model.Age.calculateYear;
import ec.edu.chickensimulationjc.model.BornOnChicken;
import ec.edu.chickensimulationjc.model.Chicken;
    ...
    public static void main(String[] args) throws IOException {
       ...
       while(!salir){
           ...
           age[i] = new Age (calculateDays(day,month,annun), calculateMonth(day,month,annun), calculateYear(day,month,annun));
            ...
            System.out.println("chiken object Molting ->" + chicken1.isMolting());
