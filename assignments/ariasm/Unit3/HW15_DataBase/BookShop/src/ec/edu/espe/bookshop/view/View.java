...
public class View extends javax.swing.JFrame {
    ...
    private static DBObject createDBObject(Book book) {
        ...
        docBuilder.append("Name", book.getName());
    ...
    private static Book createBook(String name, String author, String id, String price) {
        Book book = new Book(name, author, id, price);
        book.setName(name);
    ...
    private void BtnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegisterActionPerformed
        // TODO add your handling code here:
        Book book = new Book(txtName.getText(), txtAuthor.getText(), txtId.getText(), txtPrice.getText());
        list.add(book);
        show1();
        try {
            // TODO add your handling code here:
