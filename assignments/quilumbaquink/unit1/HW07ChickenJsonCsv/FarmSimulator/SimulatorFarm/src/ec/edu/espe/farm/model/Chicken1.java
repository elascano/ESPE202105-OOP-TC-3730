...
public class Chicken1 {
    ...
    public String toString() {
        return "Chicken{" + "id=" + id + ", name=" + name + ", color=" + color + ", molting=" + molting + ", eggCounter=" + eggCounter + '}';
    }
    

    

    public Chicken1(int id, String name, String color, Date age, Date bornOn, boolean molting) {
        this.id = id;
        this.name = name;
        this.color = color;
        //this.age = age;
    ...
    private void wander(){
        System.out.println(" wnadering from one chicken coop to another ");
    }
    private void eat(){
